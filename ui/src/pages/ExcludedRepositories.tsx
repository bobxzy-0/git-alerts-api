...
export const ExcludedRepositories: React.FC<{ embedded?: boolean }> = ({ embedded = false }) => {
  ...
  return <div className="space-y-6">
    <div>{!embedded && <h1 className="text-3xl font-bold">Excluded Repositories</h1>}<p className="text-muted-foreground mt-2">Excluded repositories do not enter detection engines; historical scans and Findings are retained.</p></div>
