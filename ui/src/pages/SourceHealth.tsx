...
export const SourceHealth: React.FC = () => {
  const { data=[], isLoading } = useQuery({queryKey:['source-health'],queryFn:sourceHealthApi.list,refetchInterval:5_000,refetchIntervalInBackground:false,refetchOnWindowFocus:true,staleTime:0});
