...
from .views import (
    FindingView,
    FindingDetailsView,
    IgnoreFindingTypeView,
    IgnoreFindingTypeDetailsView,
    IgnoreFindingDomainView,
    IgnoredFindingDomainDetailView,
)
from .bulk_delete import FindingBulkDeleteView

urlpatterns = [
    path('findings/', FindingView.as_view(), name='finding'),
    path('findings/bulk-delete/', FindingBulkDeleteView.as_view(), name='finding-bulk-delete'),
